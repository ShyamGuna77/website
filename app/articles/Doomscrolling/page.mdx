...
export const article = {
  ...
  tags: ["General","SocialMedua","Addiction"],
};
...
<div className="callout callout-tip">
  ...
  <ul>
    <li>Phone out of reach when I'm working</li>
    <li>Using Twitter intentionally for ideas, not drama</li>
    <li>Reading real books (not feeds)</li>
    <li>cutting off Instagram</li>
    <li>Spending more time… offline</li>
  </ul>
</div>
